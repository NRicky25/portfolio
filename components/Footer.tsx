    ...
    <footer className="w-full pt-20 pb-10" id="contact">
      <div className="flex flex-col items-center">
        <h1 className="heading lg:max-w-[45vw]">
          ...
          <span className="text-[#ffff99]">expert guidance</span>
        </h1>
        <p className="text-white-200 md:mt-10 my-5 text-center">
          Let’s connect to explore tailored solutions that drive your success
          and transform your ideas into reality.
        </p>
        <a href="mailto:kengeangkang@gmail.com">
          <MagicButton
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center">
        <p className="md:text-base text-sm md:font-normal font-light">
          Copyright © 2024-2025 Ricky Kang
        </p>
